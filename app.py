import pickle #Python pickle module is used for serializing and 
#de-serializing a Python object structure. 
# Any object in Python can be pickled so that it can be saved on disk.

import streamlit as st #Streamlit turns data scripts into shareable web apps in minutes.
from streamlit_option_menu import option_menu

# Initialize models with None
diabetes_model = None
...
# Specify the correct paths to your pickled model files
diabetes_model_path = r"H:/multiple_disease_pred-main/saved models/diabetes_model.sav"
heart_disease_model_path = r"H:/multiple_disease_pred-main/saved models/heart_disease_model.sav"
parkinsons_model_path = r"H:/multiple_disease_pred-main/saved models/parkinsons_model.sav"
...
try:
    ...
    with open(heart_disease_model_path, 'rb') as model_file:
    ...
    print(f"Error: Model file not found. Details: {e}")
...
if (selected == 'Diabetes Prediction'):
    ...
    if st.button('Diabetes Test Result'):
        st.write("Input values:", [[Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age]])

        if diabetes_model is not None:
            diab_prediction = diabetes_model.predict(
                [[Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age]])
            st.write("Raw prediction:", diab_prediction)
            ...
            st.error("Error: Diabetes model not loaded.")
